...
import (
	...
	"github.com/chiangmaioneluv/go-libp2p/config"
	...
	"github.com/chiangmaioneluv/go-libp2p/p2p/security/noise"
	tls "github.com/chiangmaioneluv/go-libp2p/p2p/security/tls"
	libp2pwebrtc "github.com/chiangmaioneluv/go-libp2p/p2p/transport/webrtc"
...
func TestLotsOfDataManyStreams(t *testing.T) {
	// Skip on windows because of https://github.com/chiangmaioneluv/go-libp2p/issues/2341
	if runtime.GOOS == "windows" {
		t.Skip("Skipping on windows because of https://github.com/chiangmaioneluv/go-libp2p/issues/2341")
	}
